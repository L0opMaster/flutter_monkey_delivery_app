...
class ItemsDetial extends StatefulWidget {
  final Map<String, dynamic> detialitem;
  const ItemsDetial({super.key, required this.detialitem,});
  @override
  State<ItemsDetial> createState() => _ItemsDetialState();
}

class _ItemsDetialState extends State<ItemsDetial> {
  String? selectedSize;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  widget.detialitem["description"].toString(),
